export default function NavBar() {
    return (
        <div className="flex flex-col space-y-3 pr-3 absolute right-0">
            <div className=" hover:bg-blue-100 p-3 rounded-full hover:duration-300 cursor-pointer">
            ...
            <div className="flex space-x-5 hover:bg-slate-100 p-3 rounded-full hover:duration-300 cursor-pointer font-bold text-xl">
